...
import 'infinite_tabview.dart';

const _tabAnimationDuration = Duration(milliseconds: 550);

@visibleForTesting
class InfiniteTabviewInner extends StatefulWidget {
  const InfiniteTabviewInner({
    Key? key,
    required this.size,
  ...
  @override
  InfiniteTabviewInnerState createState() => InfiniteTabviewInnerState();
}

@visibleForTesting
class InfiniteTabviewInnerState extends State<InfiniteTabviewInner>
